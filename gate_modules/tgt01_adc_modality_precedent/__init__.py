...
-> Gate-neutral EvidencePackages -> assessment proposal envelope. Web retrieval,
source registry, the reusable Evidence Library, persistence, human approval and
canonical persistence are outside it (injected ports).
"""
...
from .contracts import (
    ...
    MODULE_ID,
    MODULE_VERSION,
    TARGET_ATTRIBUTABLE_FAILURE_CLASSES,
